package com.chenshuhong.blog.orika;
...
//
//    map(Class toClass, T data, Map<String, String> configMap)
//    这是个自定义配置的映射集合，当name
//
//    mapAsList(Class toClass, Collection data)
//    这个是针对集合的映射
//
//    mapAsList(Class toClass, Collection data, Map<String, String> configMap)
//    这是针对集合配置并且自定义配置
